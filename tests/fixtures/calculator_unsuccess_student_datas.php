...
return [
    'output: hiba, nem lehetséges a pontszámítás a kötelező érettségi tárgyak hiánya miatt' => [
        ...
        new ValidatorResult(false, 'A kötelező érettségi tantárgyak közül nem végezte ' .
                                        'el az alábbiakat: magyar nyelv és irodalom, történelem')
    ],
    ...
    a magyar nyelv és irodalom tárgyból elért 20% alatti eredmény miatt' => [
        ...
        new ValidatorResult(false, 'Az egyik tantárgy eredménye 20% alatti!')
    ]
];
